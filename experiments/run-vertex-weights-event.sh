...
OUT_PATH="${BASE_PATH}/experiments/vertex-weights-event"
PARTITION_PATH="${BASE_PATH}/partition/graph-for-metis-w-vertex-weight.txt"
...
HOST_FILE="${BASE_PATH}/experiments/hostfile-vertex-weights-event"
HOST_FILE2="${BASE_PATH}/experiments/hostfile-vertex-weights-event2"
...
# Use HOST_FILE2 to run for np=56
np=56
for i in 0 1 2 3 4
do
